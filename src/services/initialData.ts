...
export const INITIAL_PLAYERS: Player[] = [
  ...
  { id: '2', number: 2, name: 'Huỳnh Tấn Phong', stamina: 8, attack: 7, defense: 7.5, positions: ['AL', 'PI', 'FI'] },
  { id: '3', number: 3, name: 'Mai Thanh', stamina: 6, attack: 7.5, defense: 6.5, positions: ['GK', 'FI'] },
  ...
  { id: '6', number: 6, name: 'Nguyễn Cao Tấn', stamina: 7.5, attack: 9, defense: 6, positions: ['PI', 'AL'] },
  ...
  { id: '9', number: 9, name: 'Phạm Hữu Thành', stamina: 5, attack: 6, defense: 6, positions: ['GK', 'FI', 'AL'] },
  { id: '10', number: 10, name: 'Trần Hoàng Hiệp', stamina: 10, attack: null, defense: null, positions: ['AL'] },
  ...
  { id: '13', number: 13, name: 'Vũ Trọng Phúc', stamina: 7.5, attack: 6, defense: 7, positions: ['GK', 'FI'] },
...
export const INITIAL_TACTICAL_SQUAD = {
  formationId: '4-0',
  slots: [
    { id: 'slot-0', role: 'GOALKEEPER' as const, label: 'GOALKEEPER', x: 10, y: 50, playerId: '13' },
    { id: 'slot-1', role: 'FIXO' as const, label: 'ALA DƯỚI TRÁI', x: 42, y: 25, playerId: '1' },
    { id: 'slot-2', role: 'FIXO' as const, label: 'ALA DƯỚI PHẢI', x: 42, y: 75, playerId: '2' },
    { id: 'slot-3', role: 'ALA_LEFT' as const, label: 'ALA TRÊN TRÁI', x: 75, y: 25, playerId: '4' },
    { id: 'slot-4', role: 'ALA_RIGHT' as const, label: 'ALA TRÊN PHẢI', x: 75, y: 75, playerId: '6' },
  ],
  notes: '',
};
