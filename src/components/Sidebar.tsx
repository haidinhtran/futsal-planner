...
interface SidebarProps {
  ...
  setActiveTab: (
    tab: "tactics" | "players" | "presentation" | "settings",
  ) => void;
  isCollapsed: boolean;
      ...
      >
        ...
        <span
          className={`transition-all duration-200 overflow-hidden whitespace-nowrap ${
            isExpanded
              ? "opacity-100 max-w-xs ml-2 pr-3"
        ...
        <div className="relative flex items-center px-3 py-1">
          ...
          <div
            className={`transition-all duration-200 overflow-hidden ${
              isExpanded
                ? "opacity-100 max-w-xs ml-2.5"
                : "opacity-0 max-w-0 ml-0 pointer-events-none"
            }`}
          >
            <h1 className="text-h3 text-slate-900 leading-none whitespace-nowrap">
              FTSP
            </h1>
